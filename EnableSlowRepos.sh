...
ShowLicense
echo "Enabling slow repos..."
prefix="/etc/zypp/repos.d"
mv $prefix/ssu_adaptation0_release.repo.bk $prefix/ssu_adaptation0_release.repo
mv $prefix/ssu_apps_release.repo.bk $prefix/ssu_apps_release.repo
mv $prefix/ssu_hotfixes_release.repo.bk $prefix/ssu_hotfixes_release.repo
